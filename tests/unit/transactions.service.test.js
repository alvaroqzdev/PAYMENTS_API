...
describe('transaction()', () => {
    ...
    it('deve retornar uma transacao valida', async () => {
        ...
        const result = await transaction(sender, recipient, amount)

        expect(result).toEqual({ debitCount, creditCount, createTransactionTableData })
    ...
    it('deve retornar uma transacao invalida, saldo insuficiente', async () => {
        ...
        await expect(transaction(sender, recipient, amount)).rejects.toThrow('Insuficient Balance')
    ...
    it('deve retornar uma transacao invalida, usuarios iguais', async () => {
        ...
        await expect(transaction(sender, recipient, amount)).rejects.toThrow('SenderId and recipientId are equals')
